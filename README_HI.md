...
विकेंद्रीकृत स्क्रेपर बनाएँ, उन्हें अलग वातावरण में परखें, और WatchBuddy इकोसिस्टम से आसानी से जोड़ें।
...
यह ब्लूप्रिंट WatchBuddy के लिए मानकीकृत प्रदाता सेवा बनाने का आधार देता है। प्रदाता एक स्वतंत्र सेवा है जो विकेंद्रीकृत नेटवर्क के माध्यम से WatchBuddy वेब और मोबाइल क्लाइंट तक सामग्री पहुँचाती है।

- 🔌 **तुरंत जोड़ें:** अपना प्रदाता URL WatchBuddy में जोड़ें और तुरंत उपयोग शुरू करें।
- 🧪 **अलग विकास वातावरण:** स्थानीय-प्रथम संरचना आपको मुख्य सिस्टम से अलग रहकर प्लगइन जाँचने देती है।
- 🎬 **एकीकृत मीडिया कोर:** उन्नत लिंक निष्कर्षण के लिए KekikStream पर आधारित।
- 🛡️ **CORS अनुकूल:** आवश्यकता पड़ने पर सामान्य CORS या प्रॉक्सी व्यवस्था के साथ काम करता है।
...
3. अपना मूल URL चिपकाएँ, जैसे http://127.0.0.1:3310।
...
ज़्यादा शीर्षक खोजने और उन्हें जल्दी से रूम में भेजने के लिए आप इन सेवाओं का भी उपयोग कर सकते हैं:
...
बिल्ट-इन validator का उपयोग करें ताकि यह सुनिश्चित हो सके कि प्लगइन WatchBuddy मॉडल के साथ संगत हैं।
...
यह SDK लोकल-फर्स्ट loader उपयोग करता है:
- स्थानीय Plugins को प्राथमिकता से लोड किया जाता है.
- स्थानीय Extractors core extractors को बढ़ा या override कर सकते हैं.
