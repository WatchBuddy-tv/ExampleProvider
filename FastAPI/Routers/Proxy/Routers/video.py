...
from FastAPI              import Request, Response, StreamingResponse
...
async def video_proxy(request: Request, url: str, referer: str = None, user_agent: str = None, force_proxy: str = None):
    ...
    # Create client (SSL verification disabled - some servers use self-signed certificates)
    ...
    try:
        ...
        # If HEAD request, do not stream, close and return
        ...
        # If HLS manifest, rewrite content
        if is_hls:
            # Read all content
        ...
        # Normal video - return StreamingResponse
        ...
        await client.aclose()
        konsol.print(f"[red]Proxy startup error: {str(e)}[/red]")
